...
public class Headinjury extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        guidelines.setOnClickListener( new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Headinjury.this, Guidelines.class));
                finish();
            }
        });
        ...
        firstaid.setOnClickListener( new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                startActivity(new Intent(Headinjury.this, Firstaid.class));
                finish();
            }
        });
        ...
        redcross.setOnClickListener( new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                startActivity(new Intent(Headinjury.this, Redcross.class));
                finish();
            }
        });
