...
public class Brokenbone extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //set activity layout
        setContentView(R.layout.activity_brokenbone);
        ...
        guidelines.setOnClickListener( new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Brokenbone.this, Guidelines.class));
                finish();
            }
        });
        ...
        firstaid.setOnClickListener( new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                startActivity(new Intent(Brokenbone.this, Firstaid.class));
                finish();
            }
        });
        ...
        redcross.setOnClickListener( new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                startActivity(new Intent(Brokenbone.this, Redcross.class));
                finish();
            }
        });
